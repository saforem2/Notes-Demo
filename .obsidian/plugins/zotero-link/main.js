...
var ZoteroLinkSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    description.append(description.createEl("a", {
    ...
    availableKeywords.append("Following keywords are available:", keywordList);
...
// src/ZoteroLink.ts
var import_nunjucks = __toModule(require_nunjucks());
var ZoteroLink = class extends import_obsidian2.Plugin {
  onload() {
